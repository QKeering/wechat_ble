...
expectSource('business history bridge', bridge, 'ringBle.readLocalData(readAll, historyStartDate, dataTypes, { timeoutMs })');
expectSource('business history bridge', bridge, 'ringBle.readLocalData(true, historyStartDate, fallbackDataTypes, { timeoutMs: fallbackTimeoutMs })');
